        ...
        <Container>
            <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
                ...
                <div className="w-full md:w-1/3 mb-6 md:mb-0">
                    ...
                    <p className="mb-2">crucial component of an online shop, serving as a platform to establish trust, credibility, and a personal connection with customers. It provides comprehensive information about the company, its mission, values, history, team, and contact details.</p>
